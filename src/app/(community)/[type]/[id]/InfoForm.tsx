    ...
    <section className="mb-2 p-4">
      <form action={ deletePost }>
        ...
        <div className="flex justify-end my-4">
          <Link href={`/${item.type}`} className="bg-orange-500 py-1 px-4 text-base text-white font-semibold ml-2 hover:bg-amber-400 rounded">목록</Link>
          <Link href={`/${item.type}/${id}/edit`} className="bg-gray-900 py-1 px-4 text-base text-white font-semibold ml-2 hover:bg-amber-400 rounded">수정</Link>
